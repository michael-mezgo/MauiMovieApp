namespace MauiMovieApp.UI.Models;
...
)
{
    ...
    public static List<Movie> GetMovies()
    {
        List<Movie> movies =
        [
            new Movie(id: "tt0416449", title: "300", year: "2006", genre: "Action, Drama, Fantasy",
            ...
            // Used ChatGPT to "convert" the movies from Kotlin to C#
            // One movie written in C# was given to ChatGPT as a template
            new Movie(
                id: "tt0848228",
                title: "The Avengers",
                year: "2012",
